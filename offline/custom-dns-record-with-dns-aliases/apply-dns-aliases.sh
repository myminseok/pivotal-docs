...
bosh -d cf-f30f16d0a030d67be63a ssh clock_global -c 'sudo rm -rf /tmp/aliases.json'
...
bosh -d cf-f30f16d0a030d67be63a ssh diego_cell -c 'sudo rm -rf /tmp/aliases.json'
