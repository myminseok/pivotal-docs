...
> /tmp/blobs/windows2019fs/blobs/sha256/$file_name
# remove new line at the end of file to keep sha256sum.
truncate -s -1 /tmp/blobs/windows2019fs/blobs/sha256/$file_name
actual_hash=$(sha256sum /tmp/blobs/windows2019fs/blobs/sha256/$file_name | awk '{print $1}')
if [ "x$actual_hash" != "x$file_name" ]; then
    echo "sha256sum hash of file /tmp/blobs/windows2019fs/blobs/sha256/$file_name doesnot match" 
    exit 1
fi
...
> /tmp/blobs/windows2019fs/blobs/sha256/817f551aeb16ca932aa3ee7b09e8e818042c0650c87711faae17e4900b5e6f5b
# remove new line at the end of file to keep sha256sum.
truncate -s -1 /tmp/blobs/windows2019fs/blobs/sha256/$file_name
actual_hash=$(sha256sum /tmp/blobs/windows2019fs/blobs/sha256/$file_name | awk '{print $1}')
if [ "x$actual_hash" != "x$file_name" ]; then
