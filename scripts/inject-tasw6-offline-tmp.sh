...
## the same info can be obtained from manifest.json that is packaged in windowsfs/windows2016fs:2019.0.167.tar/manifest.json  after "imgpkg copy -i cloudfoundry/windows2016fs:2019.0.167 --to-tar windows2016fs:2019.0.167.tar"
...
## https://github.com/cloudfoundry/hydrator/blob/27f4e1335b72ffb08629419371e6fb90801f9db0/downloader/downloader.go#L66
## https://github.com/cloudfoundry/hydrator/blob/27f4e1335b72ffb08629419371e6fb90801f9db0/oci-directory/write.go#L19
## the same info can be obtained from manifest.json that is packaged in windowsfs/windows2016fs:2019.0.167.tar  after "imgpkg copy -i cloudfoundry/windows2016fs:2019.0.167 --to-tar windows2016fs:2019.0.167.tar"
